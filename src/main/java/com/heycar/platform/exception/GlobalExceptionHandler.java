...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value= {CsvDataTypeMismatchException.class})
    public final ResponseEntity<ErrorDetails> csvValidationException(CsvDataTypeMismatchException ex, WebRequest request) {
